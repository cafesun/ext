...
#   pragma warning (push)
#   pragma warning (disable:4251 4512) // class 'boost::shared_ptr<T>' needs to have dll-interface to be used by clients of class 'boost::program_options::option_description'
#endif
